...
class PosePainter extends CustomPainter {
  ...
  final pointPaint = Paint()..color = const Color.fromRGBO(0, 0, 0, 0.8);
  final leftPointPaint = Paint()..color = const Color.fromRGBO(0, 205, 255, 1.0);
  final rightPointPaint = Paint()..color = const Color.fromRGBO(45, 255, 0, 1.0);
